import {
  AsssignedByMeAttentionNeededEnum,
  CorrectiveActionsPriorityEnum,
  CorrectiveActionsStatusEnum,
  IncidentReportingIncidentsStatusEnum,
  IncidentsSeverityEnum,
} from '@EHSNavigator/types';
...
export const CORRECTIVE_ACTION_STATUS = enumToDropdownArray(
  CorrectiveActionsStatusEnum,
  ['Draft'],
);
export const INCIDENTS_STATUS = enumToDropdownArray(
  IncidentReportingIncidentsStatusEnum,
  ['Draft'],
);
export const SEVERITIES = enumToDropdownArray(IncidentsSeverityEnum);
export const CORRECTIVE_ACTION_PRIORITY = enumToDropdownArray(
  CorrectiveActionsPriorityEnum,
);
export const ATTENTION_NEEDED = enumToDropdownArray(
  AsssignedByMeAttentionNeededEnum,
);
